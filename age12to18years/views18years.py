...
def process_symptoms(request):
    if request.method == 'POST':
       ######for string
        ...
        return render(request, 'w_disease18years.html', {'matched_diseases': matched_diseases})
    else:
...
def treatment(request, disease_id):
    ...
    return render(request, 'w_treatment18years.html', {'disease': disease, 'medicines': medicines})

def get_symptoms18years(request, disease_id):
...
def get_suggestions18years(request):
